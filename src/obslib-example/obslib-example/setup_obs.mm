...
//  rtmpTest
//
//  Created by Larry Aasen on 10/25/20.
...
//#include "obslib/obslib_framework.h"
#include "obslib/util/base.h"
...
static void frame_callback(void *param, obs_source_t *source, obs_source_frame *frame);
...
//    obs_data_set_string(camerSettings, "device", "0x8020000005ac8514");
    ...
    // Load camera
    SourceContext cameraSource{
        obs_source_create("av_capture_input", "camera", camerSettings, nullptr)};
    if (!cameraSource)
